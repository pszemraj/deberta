...
if triton is not None:
    # Runtime parameters are annotated ``None`` on purpose: a real type such as
    # ``int`` makes triton pin the argument type and skip value specialization.
    # See ``kernel_runtime_parameter_annotations`` in tests/test_flashdeberta_patch.py.
    @triton.jit
    def _dense_bias_fwd_kernel(
        ...
        stride_pq_s: None,
        stride_pq_p: None,
        stride_bucket_s: None,
        stride_bucket_n: None,
        stride_mask_b: None,
        stride_mask_h: None,
        stride_mask_s: None,
        stride_mask_n: None,
