...
On current `hf_deberta_v2` runs, dense packed `1024` batches may route through the repo-local local-bias flash path automatically; padded batches still use the varlen path.
