...
For `hf_deberta_v2`, packed doc-block routing is now also supported through the flash config flag. The repo ships tracked packed doc-block benchmark configs at `configs/custom/pretrain_rtd_hf_deberta_v3pos_smol2stage4_{1024,2048,4096}_wp32k_v2_docblock.yaml`.
